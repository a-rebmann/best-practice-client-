...
export const LEVEL_DESCRIPTIONS = {
  ...
  'Multi-object': 'Multi-object constraints capture relations that should hold between pairs of business objects occurring in a process, e.g., that a trace can only contain an invoice if there is also at least one activity related to a delivery',
